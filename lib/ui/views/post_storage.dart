...
class _PostStoragePageState extends State<PostStoragePage> {
  final List<Map<String, dynamic>> storedPosts = [
    {
      'id': 1,
      'author': '나의 반려견',
      ...
      MaterialPageRoute(
        builder: (context) => PostDetailPage(
          ...
          onPostUpdate: (updatedPost) {
            setState(() {
              final index =
                  storedPosts.indexWhere((p) => p['id'] == updatedPost['id']);
              if (index != -1) {
                  ...
                  child: Card(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          CircleAvatar(
                            backgroundImage: NetworkImage(post['profileImagePath']),
                            radius: 25,
                          ),
