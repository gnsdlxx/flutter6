...
class _ProfileState extends State<Profile> {
  ...
  if (selectedPet == null) return const SizedBox.shrink(); // 선택된 반려동물이 없으면 빈 공간 반환
  ...
  return Padding(
    ...
    child: ListView(
      children: [
        ...
        // 이미지
        if (selectedPet!['imageUrl'] != null && selectedPet!['imageUrl'].isNotEmpty)
          Container(
            width: double.infinity,
        ...
        Row(
          children: [
            IconButton(
              icon: Icon(
                selectedPet!['isLiked'] ? Icons.favorite : Icons.favorite_border,
                color: Colors.red,
              ),
              onPressed: () {
                setState(() {
